...
**Questions and notes/concerns**
1. We are aware that the number of floors, bathrooms, and bedrooms in this context could also be used as categorical variables in an anova setting. Would it be more advisable to doa linear regression or ANOVA/ both?
